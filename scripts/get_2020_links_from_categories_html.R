...
get_links <- function(file_to_look_at){
  ...
  category <- str_replace(file_to_look_at, "inputs/2020/lists/lists_by_categories/", "") %>% 
    str_replace(".html", "")
...
the_files <- c(
  "inputs/2020/lists/lists_by_categories/accessories.htm",
  "inputs/2020/lists/lists_by_categories/bracelet.htm",
  "inputs/2020/lists/lists_by_categories/bracelets.htm",
  "inputs/2020/lists/lists_by_categories/clasps.htm",
  "inputs/2020/lists/lists_by_categories/earrings.htm",
  "inputs/2020/lists/lists_by_categories/necklaces.htm",
  "inputs/2020/lists/lists_by_categories/rings.htm"
)
...
write_csv(the_data, "outputs/misc/2020_links_from_categories.csv")
