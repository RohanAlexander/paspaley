...
get_links <- function(file_to_look_at){
  ...
  category <- str_replace(file_to_look_at, "inputs/2019/lists/lists_by_categories/", "") %>% 
    str_replace(".html", "")
...
the_files <- c(
  "inputs/2019/lists/lists_by_categories/accessories.html",
  "inputs/2019/lists/lists_by_categories/bracelets.html",
  "inputs/2019/lists/lists_by_categories/clasps.html",
  "inputs/2019/lists/lists_by_categories/earrings.html",
  "inputs/2019/lists/lists_by_categories/necklaces.html",
  "inputs/2019/lists/lists_by_categories/rings.html"
)
...
write_csv(the_data, "outputs/misc/2019_links_from_categories.csv")
